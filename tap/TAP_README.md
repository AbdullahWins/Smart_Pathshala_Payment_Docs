# Smart Paathshala Tap Payment Integration

This documentation covers the Tap payment integration for Smart Paathshala's payment system.

## Authentication

All Tap API endpoints require Basic Authentication with the following credentials:

```
Username: testTapUser
Password: testTapPassword
```
...
Host: localhost:5000
Authorization: Basic dGVzdFRhcFVzZXI6dGVzdFRhcFBhc3N3b3Jk
...
2. **Process Payment**:
   - After user completes payment through Tap
